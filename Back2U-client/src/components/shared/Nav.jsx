...
const Nav = () => {
  ...
  // Track scroll to apply fixed navbar
  useEffect(() => {
      ...
      <div className="sm:py-3 py-2 w-full pl-4 pr-7 navbar">
        ...
        <div className="lg:hidden navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] -left-2 p-2 bg-base-100 w-max gap-2 font-medium transition-all rounded-lg shadow-lg"
            >
              <NavLink
                to="/"
                className={({ isActive }) =>
        ...
        {/* Desktop Navbar: Right-aligned links */}
              ...
              >
                ...
                <li>
                  <Link
                    ...
                    className="border-[0.1rem] border-transparent hover:text-yellow-400 hover:border-yellow-400 font-medium"
                  >
                    Logout
                  </Link>
                </li>
