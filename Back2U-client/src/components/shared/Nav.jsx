      ...
      <div className="sm:py-3 py-2 w-full pl-4 pr-7 navbar">
        ...
        <div className="hidden lg:flex min-w-max navbar-center">
          <ul className="font-medium gap-4 flex items-center">
            ...
            <NavLink to="/app/items" className={pages}>Items</NavLink>
            <NavLink to="/app/lost-reports" className={pages}>My Lost Reports</NavLink>

            {/* Held & Request Dropdown */}
            <div className="dropdown">
              ...
              <ul tabIndex={0} className="dropdown-content menu p-2 mt-2 shadow-md bg-base-100 rounded-lg min-w-max">
                <li>
                  <NavLink to="/app/feature15/create" className={({ isActive }) => isActive ? "px-3 py-1 bg-base-200 rounded" : "px-3 py-1 hover:bg-base-200 rounded"}>
                    Create Item
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/app/feature15/mine" className={({ isActive }) => isActive ? "px-3 py-1 bg-base-200 rounded" : "px-3 py-1 hover:bg-base-200 rounded"}>
                    My Items
                  </NavLink>
                </li>
              </ul>
            ...
            <div className="dropdown">
              <button tabIndex={0} className={pages}>Admin</button>
              <ul tabIndex={0} className="dropdown-content menu p-2 mt-2 shadow-md bg-base-100 rounded-lg min-w-max">
                {adminLinks.map((link) => (
                  <li key={link.to}>
                    <NavLink
                      to={link.to}
                      className={({ isActive }) => isActive ? "px-3 py-1 bg-base-200 rounded" : "px-3 py-1 hover:bg-base-200 rounded"}
                    >
                      {link.name}
                    </NavLink>
                  </li>
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] -left-2 p-2 bg-base-100 w-max gap-2 font-medium">
            ...
            <li tabIndex={0}>
              ...
              <ul className="p-2 bg-base-100 rounded-lg mt-1">
                <li><NavLink to="/app/feature15/create" className={({ isActive }) => isActive ? "px-3 py-1 bg-base-200 rounded" : "px-3 py-1 hover:bg-base-200 rounded"}>Create Item</NavLink></li>
                <li><NavLink to="/app/feature15/mine" className={({ isActive }) => isActive ? "px-3 py-1 bg-base-200 rounded" : "px-3 py-1 hover:bg-base-200 rounded"}>My Items</NavLink></li>
              </ul>
            </li>
            ...
            <li tabIndex={0}>
              ...
              <ul className="p-2 bg-base-100 rounded-lg mt-1">
                {adminLinks.map((link) => (
                  <li key={link.to}>
                    <NavLink to={link.to} className={({ isActive }) => isActive ? "px-3 py-1 bg-base-200 rounded" : "px-3 py-1 hover:bg-base-200 rounded"}>
                      {link.name}
                    </NavLink>
                  </li>
                ))}
          ...
          {user ? (
            <div className="avatar dropdown">
              ...
              <ul tabIndex={0} className="dropdown-content top-14 right-0 z-[1] menu p-2 shadow-md shadow-yellow-400 bg-base-100 rounded-lg min-w-max transition-all">
                ...
                <li><NavLink to="/dashboard" className={pages}>Dashboard</NavLink></li>
